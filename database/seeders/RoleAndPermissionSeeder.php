...
class RoleAndPermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $manageAdmins = Permission::create(['name' => 'Manage Admins', 'guard_name' => 'api']);
        ...
        $productManagerRole->givePermissionTo([$viewProducts, $createProducts, $editProducts, $deleteProducts]);
    }
